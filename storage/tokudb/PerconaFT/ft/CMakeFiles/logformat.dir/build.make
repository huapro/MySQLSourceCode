...
storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/logger/logformat.cc.o: storage/tokudb/PerconaFT/ft/logger/logformat.cc
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/logger/logformat.cc.o"
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft && /usr/bin/c++   $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/logformat.dir/logger/logformat.cc.o -c /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft/logger/logformat.cc
...
storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/logger/logformat.cc.i: cmake_force
	...
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft/logger/logformat.cc > CMakeFiles/logformat.dir/logger/logformat.cc.i
...
storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/logger/logformat.cc.s: cmake_force
	...
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft/logger/logformat.cc -o CMakeFiles/logformat.dir/logger/logformat.cc.s
...
storage/tokudb/PerconaFT/ft/logformat: storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable logformat"
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/logformat.dir/link.txt --verbose=$(VERBOSE)
...
storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/clean:
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft && $(CMAKE_COMMAND) -P CMakeFiles/logformat.dir/cmake_clean.cmake
...
storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/depend:
	cd /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft /mnt/workspace/percona-server-5.6-source-tarballs-new/test/percona-server/storage/tokudb/PerconaFT/ft/CMakeFiles/logformat.dir/DependInfo.cmake --color=$(COLOR)
